...
export function HabitsList({date, onCompletedChenged}: HabitsListProps){
        ...
        habitsInfo?.possibleHabits.map(habit =>{
          return (
            ...
            >
                ...
                <span className='font-simebold text-xl text-white leading-tight group-data-[state=checked]:line-through group-data-[state=checked]:text-zinc-400'>
                  {habit.title}             
                </span>
            </Checkbox.Root>
